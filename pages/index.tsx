...
const Home: NextPage = () => {
  ...
  const [isTabletOrMobileState, setIsTabletOrMobileState] = useState(false);
  const isTabletOrMobile = useMediaQuery({ query: "(max-width: 943px)" });
  const router = useRouter();
  const [recentLinksState, setRecentLinksState] = useState<string[]>([]);

  useEffect(() => {
    setIsClient(true);
    if (isTabletOrMobile !== undefined) {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      setRecentLinksState(recentLinksVals);
    }
  }, [router.pathname]);
  ...
  return (
    <>
      <Head>
        <title>Yunus Emre ÖNEÇ | Software Developer</title>
        <meta
          name="description"
          content={`VS code temalı yazılım geliştirici portfolyosu`}
        />
        <link rel="icon" href="/favicon.ico" />
        <meta
          property="og:title"
          content={
            "Yunus Emre ÖNEÇ - Software Developer"
          }
        />
        <meta
          name="description"
          ...
          <div className="container vscodecontainer mx-auto max-w-5xl w-full p-6 mb:p-12">
            <div className="flex flex-col mt-1 md:flex-row md:space-x-4">
              <div className="flex-1 mb-4 md:mb-0 ">
                <div className="p-2">
                  <h2 className="text-5xl font-sans	 mb-2 ">Yunus Emre ÖNEÇ</h2>
                  <h3 className="text-2xl font-sans	 text-gray-500 pt-1 mb-2">
                  Software Developer
                  </h3>
                

                  <p className="text-xl text-gray-300 pt-5 mb-4">Başlangıç</p>
                  ...
                  <p className="text-xl text-gray-300 pt-6 mb-2 mt-5 ">Son Ziyaretler</p>
                  {recentLinksState?.length < 1 ? (
                    <p className="text-sm font-sans pt-1	 text-gray-500">
                      Henüz aktivite yok!
                    </p>
                  ) : (
                    <div className="pt-1">
                      {recentLinksState?.map((item: any, index: number) => (
                        <Link passHref href={item} key={`link-recent-${index}`}>
                          <p className="text-blue-500 cursor-pointer text-sm pb-2 font-sans flex justify-start gap-1 items-center">
                            {item?.slice(1)}{" "}
                            <p className="text-gray-300 pl-2 text-sm ">
                              E:/YunusEmreOnec{item}
                            </p>
                          </p>
                        </Link>
                      ))}
              ...
              <div className=" flex-1">
                <div
                  className="p-2 "
                  style={{ paddingTop: isTabletOrMobileState ? "5%" : "22%" }}
                >
                  <p className="text-xl text-gray-300 pt-6 mb-1 ">About</p>
                  <p className="text-sm text-gray-400 pt-1 mb-1 max-w-lg">
                    I am a dedicated software developer with a talent for quick problem-solving, creative thinking, and effective software system management. I am passionate about learning new technologies and embracing creative challenges.
                    <br /><br />
                  </p>
                  <div className="pt-1">
                    <Link
                      passHref
                      target="_blank"
                      href="https://www.linkedin.com/in/yunusemreonec/"
                    >
                      <div
                  ...
                  <div className="mt-4">
                    <Link passHref target="_blank" href="https://github.com/yunusonec">
                      <div
                        className="cursor-pointer w-full flex justify-start items-center pl-2 pr-2 p-1 
                          rounded-sm gap-2 border-b  border-blue-500 "
                        style={{
                  ...
                  <div className="mt-4">
                    <Link passHref target="_blank" href="https://discord.com/users/nwakaemre">
                      <div
                        className="cursor-pointer w-full flex justify-start items-center pl-2 pr-2 p-1 
                          rounded-sm gap-2 border-b  border-blue-500 "
                        style={{
                      ...
                      >
                        <img src="https://img.icons8.com/color/28/null/discord-logo.png" />
                        <p className="text-gray-200 text-sm  font-sans flex justify-start items-center">
                          Discord
                        </p>
                      </div>
                  ...
                  <div className="mt-4">
                    <Link passHref target="_blank" href="https://www.youtube.com/@yunusemreonec">
                      <div
                        className="cursor-pointer w-full flex justify-start items-center pl-2 pr-2 p-1 
                          rounded-sm gap-2 border-b  border-blue-500 "
                        style={{
                      ...
                      >
                        <img src="https://img.icons8.com/color/28/null/youtube-play.png" />
                        <p className="text-gray-200 text-sm  font-sans flex justify-start items-center">
                          YouTube
                        </p>
                      </div>
