...
export const SideSecondPanel: React.FC<IProps> = (props: any) => {
  ...
  useEffect(() => {
    ...
    } else if (currentSubLink === "Photography") {
      setActiveCurrentSubLink("Photography");
            ...
            {!projectsClose && (
              <div className="show-pre">
                <ul>
                  ...
                  >
                    <SidePanelSubLink
                      name="TraversalRezervasyonProje.js"
                      link="/Projects/2"
              ...
              <div className="show-pre">
                <ul>
                  ...
                  {/* <li
                    ...
                    className={` smallSide ${
                      activeCurrentSubLink === "Photography" ? "active" : ""
                    }`}
                  >
                    <SidePanelSubLink
                      name="Photography.jsx"
                      link="/Photography"
                      icon={<span className="icons8-react"></span>}
                    />
                  </li> */}
      ...
      {!isTabletOrMobile && (
        <ul className="bottom-links  pl-2">
          <li className="border-b border-solid border-gray-500 ">
            <span className="text-gray-400">Tüm Hakları Saklıdır. </span>
          </li>
          <li>
            <span className="text-gray-400"> Ⓒ Telif Hakkı 2025. </span>
          </li>
        </ul>
      )}
    </div>
